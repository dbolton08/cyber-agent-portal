...
const translations = {
  ...
  zh: {
    ...
    consoleTitle: "矩阵控制台界面",
    consoleDescription: "通过我们的高级终端界面访问核心系统",
    enterCommand: "输入命令",
    executeCommand: "执行",
    systemsTitle: "矩阵系统概览",
    systemsDescription: "监控和管理核心矩阵基础设施",
    systemHealth: "系统健康",
    systemPerformance: "性能指标",
    networkTitle: "网络状态",
    networkDescription: "实时网络统计和连接性",
    networkLatency: "网络延迟",
    networkNodes: "活动节点",
    agentsTitle: "AI代理目录",
    agentsDescription: "浏览并与我们的AI代理网络互动",
    agentStatus: "代理状态",
    deployAgent: "部署代理"
  },
  es: {
  ...
  fr: {
    ...
    consoleTitle: "Interface Console Matrix",
    consoleDescription: "Accédez aux systèmes centraux via notre interface terminal avancée",
    enterCommand: "Entrer la commande",
    executeCommand: "Exécuter",
    systemsTitle: "Aperçu des Systèmes Matrix",
    systemsDescription: "Surveillez et gérez l'infrastructure centrale Matrix",
    systemHealth: "Santé du Système",
    systemPerformance: "Métriques de Performance",
    networkTitle: "État du Réseau",
    networkDescription: "Statistiques réseau en temps réel et connectivité",
    networkLatency: "Latence Réseau",
    networkNodes: "Nœuds Actifs",
    agentsTitle: "Répertoire des Agents IA",
    agentsDescription: "Parcourez et interagissez avec notre réseau d'agents IA",
  ...
  de: {
    ...
    consoleTitle: "Matrix Konsolen-Interface",
    consoleDescription: "Zugriff auf die Kernsysteme über unser fortgeschrittenes Terminal-Interface",
    enterCommand: "Befehl eingeben",
    executeCommand: "Ausführen",
    systemsTitle: "Matrix Systemübersicht",
    systemsDescription: "Überwachen und verwalten Sie die Matrix-Kerninfrastruktur",
    systemHealth: "Systemgesundheit",
    systemPerformance: "Leistungsmetriken",
    networkTitle: "Netzwerkstatus",
    networkDescription: "Echtzeit-Netzwerkstatistiken und Konnektivität",
    networkLatency: "Netzwerklatenz",
    networkNodes: "Aktive Knoten",
    agentsTitle: "KI-Agenten Verzeichnis",
    agentsDescription: "Durchsuchen und interagieren Sie mit unserem KI-Agenten-Netzwerk",
  ...
  it: {
    ...
    consoleTitle: "Interfaccia Console Matrix",
    consoleDescription: "Accedi ai sistemi core attraverso la nostra interfaccia terminale avanzata",
    enterCommand: "Inserisci comando",
    executeCommand: "Esegui",
    systemsTitle: "Panoramica Sistemi Matrix",
    systemsDescription: "Monitora e gestisci l'infrastruttura core Matrix",
    systemHealth: "Salute del Sistema",
    systemPerformance: "Metriche di Performance",
    networkTitle: "Stato della Rete",
    networkDescription: "Statistiche di rete in tempo reale e connettività",
    networkLatency: "Latenza di Rete",
    networkNodes: "Nodi Attivi",
    agentsTitle: "Directory Agenti IA",
    agentsDescription: "Sfoglia e interagisci con la nostra rete di agenti IA",
    agentStatus: "Stato Agente",
    deployAgent: "Distribuisci Agente"
  }
};
